...
public class JsonUserStorage : IUserStorageRepo
{
    ...
    {   
        ...
        //miniLegacyRerater folder that holds our entire console app
        //Here we used a relative file path starting at miniLegacyRerater to go into
    ...
    public User FindUser(string usernameToFind)
    {
        ...
        {
            foundUser=null;    //for the first time user there is no user.json
                                //Don't crash, just return null user
